  ...
  return (
    <Layout>
      <div className={scss.wrapper} data-testid="about-page">
        ...
        <div>
          Aliquam delectus doloremque dolorum ducimus ea eaque eos esse fugit in laboriosam laborum
          molestiae nam, placeat possimus quas quia quidem recusandae reprehenderit tempore vitae!
          Architecto, ex, magni! Ad eos, vero!
        </div>
        <div>
          Animi facilis mollitia reiciendis reprehenderit sint totam. Consequuntur cum ipsum officia
          velit voluptate. Eveniet exercitationem id non pariatur sunt tempore. Accusantium
          asperiores dolorem, earum iste magni maxime nulla sit tempora.
        </div>
        <div>
        ...
        <div>
          ...
          laboriosam, molestias nesciunt nisi odit omnis perferendis quaerat quasi quisquam, ratione
          recusandae reiciendis rerum saepe similique voluptatum. Ad, quaerat, quod.
        </div>
        <div>
        ...
        <div>
          ...
          praesentium quaerat, quas repudiandae sed, soluta tempore! Accusantium blanditiis corporis
          cumque eaque eius eum ex expedita inventore nostrum sint?
        </div>
        <div>
